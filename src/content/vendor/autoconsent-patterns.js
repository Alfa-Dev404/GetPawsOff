/*!
 * autoconsent-patterns.js
 * -----------------------------------------------------------------------------
 * Multilingual cookie-consent button/text pattern banks.
 *
 * VENDORED FROM: DuckDuckGo autoconsent (lib/heuristic-patterns.ts)
 *   https://github.com/duckduckgo/autoconsent
 * LICENSE: Mozilla Public License 2.0 (MPL-2.0).
 *
 * This file is a derivative of autoconsent and REMAINS licensed under MPL-2.0.
 * It is kept source-available and isolated from PawsOff's own (separately
 * licensed) code per MPL § 3.3. Do not relicense. See AUTOCONSENT-NOTICE.txt.
 * -----------------------------------------------------------------------------
 */
(function (root, factory) {
  var api = factory();
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
  if (root) root.PawsOffConsentPatterns = api;
  ...
  return {
    ...
    NEVER_MATCH_PATTERNS: NEVER_MATCH_PATTERNS,
    SETTINGS_PATTERNS: SETTINGS_PATTERNS,
    ACCEPT_PATTERNS: ACCEPT_PATTERNS,
    ACKNOWLEDGE_PATTERNS: ACKNOWLEDGE_PATTERNS
  };
});
